...
<body background="./doodle.jpg">
	...
	<div class="container">
    	<div class="box form_box">
    	 <form action="save" method="get" class='login_form'>
    	 	<div class="field">
    	 	...
    	 	<div class="field">
    	 		...
    	 		<div class="field_input">
    	 			<input type="number" id="Phone_number" name="Phone_number" required="required" >
    	 		</div>
    	 	</div>
    	 	<div class="field">
    	 		<div class="field_label">
    	 		...
    	 		<div class="field_input">
    	 			<input type="number" id="salary" name="salary" required="required">
    	 		</div>
    	 	</div>
    	 	<div class="field">
    	 		<div class="field_label">
    	 		...
    	 		<div class="field_input">
    	 			<input type="date" id="date_of_joinning" name="date_of_joinning" required="required">
    	 		</div>
    	 	</div>
    	 	<div class="field">
    	 		<div class="field_label">
